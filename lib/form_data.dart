...
List<Map<String, dynamic>> createFormFields() {
  return [
    ...
    },
    {
      ...
      'descriptionEN':
          "Select if there is a natural monument in or near the hedge",
      'descriptionDE':
      ...
      'values': [
        '',
        'naturdenkmal_in_nahe_hecke',
        'kein_naturdenkmal_in_nahe_hecke'
      ],
      'valuesEN': [
        '',
        'Natural monument in/near the hedge',
        'No natural monument in/near the hedge'
      ],
      'valuesDE': [
        '',
    ...
    },
    {
      ...
      'values': [
        ...
        'lt_250m_or_25ha',
        '250_to_800m_or_25ha',
        '800_to_1500m_or_25ha',
        '1500_to_2200m_or_25ha',
        'gt_2200m_or_25ha'
      ],
      'valuesEN': [
        '',
    ...
    },
    {
      ...
      'descriptionEN':
          "Select if it is identifiable in the French cadastre or not",
      'descriptionDE':
      ...
      'valuesEN': [
        '',
        'Identifiable in cadastre',
        'Not identifiable in cadastre'
      ],
    ...
    },
    {
      ...
      'values': [
        ...
        'neigung_merkbar',
        'deutlich_steigend',
        'durchschn_bergstrasse',
        'steilste_abschnitte_v_bergstraßen'
      ],
      'valuesEN': [
        '',
        'approximately level',
        'slope noticeable',
        'clearly rising',
        'average mountain road',
        'steepest sections of mountain roads'
      ],
      'valuesDE': [
        '',
        'annähernd eben',
    ...
    },
    {
      ...
      'values': [
        '',
        'keine_verbindungen_natuerlichen_lr',
        '1_verbindung',
        'gt_1_verbindung',
        'teil_regennetzwerk'
      ],
      'valuesEN': [
        '',
        'no connections to (semi-) natural LR',
        '1 connection',
        '>1 connection',
        'part of rain network'
      ],
      'valuesDE': [
        '',
    ...
    },
    {
      ...
      'values': [
        '',
        'gleich_hoch_gleich_breit',
        '1_dimension_variabel',
        '2_dimensionen_variabel'
      ],
      'valuesEN': [
        '',
  ...
  return [
    ...
    },
    {
      ...
      'values': const [
        '',
        'nichts_sichtbar',
        'baum_strauch_nachgepflanzt',
        'seitenschnitt_sichtbar',
        'auf_stock_gesetzt',
        'einzelbaum_strauch_rueckschnitte',
        'einzelstamm_entnahme'
      ],
      'valuesEN': const [
        '',
        'nothing visible',
