...
List<Map<String, dynamic>> createFormFields() {
  return [
    ...
    },
    {
      ...
      "descriptionDE": """Die Höhe wird als Durchschnittswert im 30 m-Abschnitt ermittelt. Wächst die Hecke auf einer Bank, wird diese nicht mit einbezogen. Bei einer asymmetrischen Bank, bei der die Höhe der Hecke auf einer Seite geringer ist, wird die Höhe auf der niedrigeren Seite ermittelt. Ebenfalls nicht mit einbezogen in die Schät-zung werden Lücken in der Hecke sowie Einzelbäume. Bilden hingegen die Bäume das Kronendach (Baum-hecke) werden diese schon mit einbezogen.\nJe höher eine Hecke, desto schwieriger ist es, die Höhe genau zu messen. Gutachter:innen sollten ihre best mögliche Schätzung abgeben; unter realen Bedingungen kann die Höhe typischerweise auf 1-2 m Genauig-keit abgeschätzt werden.""",
      "action": null,
      "section": FormSection.structure,
      "subSectionEN": "Dimensions",
      "subSectionDE": "Abmessungen",
    ...
    },
    {
      ...
      "descriptionDE": """Es soll der Mittelwert im 30 m-Abschnitt ermittelt werden. Dieser wird entweder mit einem Maßband ge-messen, oder, wenn Ersteres nicht möglich ist, geschätzt. Ist die Heckenbreite entlang der Länge gleichmä-ßig, kann die Breite mit einem Maßband gemessen werden, am einfachsten ist dies an einer Lücke.\nVereinzelte Heckenbäume und Lücken fließen nicht in die Breite mit ein. Überhängende Pflanzenteile wer-den erst ab einer Höhe von 0,5 m zur Heckenbreite gezählt (DEFRA 2007).""",
      "action": null,
      "section": FormSection.structure,
      "subSectionEN": "Dimensions",
      "subSectionDE": "Abmessungen",
    ...
    },
    {
      ...
      "descriptionDE": """Als Baum zählt jedes lebende Gehölz mit einer dominierenden Sprossachse (Stamm) und einem Brusthöhendurchmesser (= Stammdurchmesser in 1,30 m Höhe) von über 7 cm. Keine Bäume sind demnach Sträucher, Lianen, Gräser, Kräuter, Totholz und Streu (KLINGENFUß et al. 2019).\nZielgröße für den Baumanteil ist die Anzahl der Bäume in der Hecke pro 100 m Heckenlänge. Hierfür wird die Heckenlänge benötigt (siehe oben), sowie die Gesamtanzahl der Bäume in der Hecke. Die Formel hierfür lautet:\nBaumanteil = Anzahl Bäume / Heckenlänge [m] * 100m "" """,
      "action": null,
    ...
    },
    {
      ...
      "descriptionDE": """Um die Anzahl der Gehölzarten in der Hecke festzustellen, werden die verschiedenen Gehölzarten im 30 m-Abschnitt gezählt (FOULKES et al. 2013). Es sei hier festzuhalten, dass, gerade in heterogenen Hecken die Anzahl der Gehölzarten mitunter deutlich höher sein kann, als im 30 m-Abschnitt aufgenommen.\nHilfe für die Unterscheidung der Gehölzarten bieten vor allem Blätter, Blüten/Früchte, sowie Wuchsformen. Auch Pflanzenbestimmungs-Apps wie z.B. Flora Incognita oder PlantNet können gute Dienste leisten.""",
      "action": null,
      "section": FormSection.plants,
      "subSectionEN": "Species Composition",
      "subSectionDE": "Artenzusammensetzung",
    ...
    },
    {
      ...
      "descriptionEN": """Null""",
      "descriptionDE": """Agroforstwirtschaft bezieht sich auf die Integration von Bäumen oder Sträuchern in landwirtschaftliche Flä-chen oder Systeme, um ökologische und ökonomische Vorteile zu erzielen. Bienenstöcke, Obstbäume und Holzstapel sind alles mögliche Bestandteile einer agroforstwirtschaftlichen Gestaltung von Hecken. Mehrfachnennungen sind möglich.""",
      "action": null,
    ...
    },
    {
      ...
      "labelDE": "Sonderform",
      "descriptionEN": """Null""",
      "descriptionDE": """Als Sonderform werden Hecken bezeichnet, die auf nicht ebenem Boden stocken, wie einem Hochrain. In Einzelfällen ist hier auch eine Mehrfachnennung möglich.\nBegriffserklärungen: Lesesteinhaufen sind Ansammlungen von Steinen, Hochraine sind schmale Anhäufungen von Erde und Böschungen sind geneigte Flächen oder Hänge.""",
      "action": null,
      "section": FormSection.structure,
      "subSectionEN": "Position and Characteristics",
      "subSectionDE": "Position und Eigenschaften",
